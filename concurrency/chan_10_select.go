...
// not deterministic due to the concurrent nature of goroutines and the usage of the select statement. The select statement randomly chooses a case among those that are ready to execute.
